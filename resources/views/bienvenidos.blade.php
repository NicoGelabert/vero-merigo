...
<head>
	...
	<link rel="stylesheet" href="{{ asset('/css/modern-blog.css') }}" type="text/css" />
	<link rel="stylesheet" href="{{ asset('/css/fonts.css') }}" type="text/css" />
	<link rel="stylesheet" href="{{ asset('/css/colors.php?color=dc3545') }}" type="text/css" />
	<!-- / -->
			...
			<div id="header-wrap">
				<div class="container-fluid">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="index.html" class="standard-logo" data-mobile-logo="{{ asset ('/storage/images/logo.png')}}"><img src="{{ asset ('/storage/images/logo-dark.png')}}" alt="Canvas Logo"></a>
							<a href="index.html" class="retina-logo" data-mobile-logo="{{ asset ('/storage/images/logo@2x.png')}}"><img src="{{ asset ('/storage/images/logo-dark@2x.png')}}" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
			...
			<div class="content-wrap pt-lg-0 pt-xl-0 pb-0">
					...
					<div class="row grid-container infinity-wrapper clearfix">
						...
						<div class="col-md-6 p-3">
							<div class="entry mb-1 dark clearfix" style="background: url('demos/modern-blog/images/items/5.jpg') no-repeat center bottom; background-size: cover; height: 525px;">
								...
								<div class="entry-content">
									<p class="font-weight-light">Magni velit facilis donec quasi quidem error animi, rutrum sequi mi officia.</p>
								</div>
				...
				<div class="section bg-white pt-4 pb-0 topmargin-sm mb-0">
					...
					<div class="instagram-button position-relative">
						<div id="instagram-photos" class="instagram-photos masonry-thumbs grid-container grid-6" data-user="blog.canvastemplate"></div>
						<a href="#" class="button bg-white button-light button-rounded text-dark m-0 clearfix">Follow us on Instagram</a>
					</div>
				</div>
